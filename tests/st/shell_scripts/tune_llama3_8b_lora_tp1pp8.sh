...
CKPT_LOAD_DIR="/data/ci/models/llama3/hf/llama-3-8b-hf/"
MG_CACHE_DIR="/data/ci/cache/llama-3-8b-tp1pp8"
OUTPUT_PREFIX="/data/ci/cache/llama3-8b-dataset/llama3_8b"
