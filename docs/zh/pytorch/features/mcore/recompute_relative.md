...
详细的算法原理可参见 [Megatron 重计算](https://arxiv.org/abs/2205.05198)、MindSpeed [激活函数重计算](https://gitcode.com/Ascend/MindSpeed/blob/master/docs/zh/features/activation-function-recompute.md) 章节
